...
st.title("Dr. Z.C.M.")
st.title('AI and peripheral intravenous cannulation success')  # 算法名称 and XXX

COL_INPUT = [
    'Age', 'Sex', 'Length', 'Weight', 'BMI', 'Palpable', 'Visual', 'CatheterSize', 'DiaVene', 'CVR', # 'Fail'
]
...
def do_processing():
    ...
    # 分割数据
    X_train, X_test, y_train, y_test = do_split_data(pocd, random_state=3)
